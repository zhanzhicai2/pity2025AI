...
class TestCase(PityBase):
    ...
    name = Column(String(32), index=True, comment='用例名称')
    ...
    body_type = Column(INT, comment='请求body类型 0: none 1: json 2: form 3: x-form 4: binary 5: GraphQL')
    directory_id = Column(INT, comment='所属目录ID')
